...
public class ExemploArrayDeque {
    ...
    private static void acessandoDaFila() {
        ...
        ad.add("Red"); // Fila 1 - chamada de "ad"
        ad.add("Blue");
        ad.add("White");
        ad.add("Yellow");
        ad.add("Black");
        ...
        d.add("green"); // Fila 2 - chamada de "d"
        d.add("Orange");

        ad.addAll(d);  // add todos na mesma fila (ad+d), colocando tudo na "ad"

        System.out.println(ad);
        System.out.println(ad.contains("White")); // verificar se na fila contem "WHITE"
        System.out.println(d.contains("Brown")); // verificar se na fila contem "Brown"
        System.out.println(d.containsAll(d)); // se na variavel "d" contem todos de "d"
        ...
        System.out.println("Output pf peek: " + ad.peek());
    ...
    private static void  inserindoNaFila() {
        ...
        System.out.println("Elements in the ArrayDeque after add, addFirst and addLast: " + d);
        ...
        System.out.println("Elements in the ArrayDeque after addAll: " + d);

        boolean val = d.offer("Jaipur");
        d.offerFirst("Goa");
        d.offerLast("Mumbai");

        System.out.println("Elements in the ArrayDeque after offer, offerFirst, offerLast : " + d);

        d.push("kolkata");

        System.out.println("Elements in the ArrayDeque after push: " + d);
        System.out.println("");
    }
